...
public class All_Live_Merchant_Shopify_login_and_session_creation_after_Kwikpass_login_daily_check extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Soul_Theory_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Soul_Theory_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://soultheory.in/");
		logger.info("URL is open");
		logger.info("soul theory does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://soultheory.in/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in soul theory after Kwikpass login passed.");
			logger.info("Verify_Soul_Theory_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Soul theory after Kwikpass login failed.");
			logger.info("Verify_Soul_Theory_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Soul_Theory_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Soul_Theory_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Mille_supergrains_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Mille_supergrains_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://millesupergrain.com/");
		logger.info("URL is open");
		logger.info("Mille Supergrains does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://millesupergrain.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Mille Supergrains after Kwikpass login passed.");
			logger.info("Verify_Mille_supergrains_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Mille Supergrains after Kwikpass login failed.");
			logger.info("Verify_Mille_supergrains_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Mille_supergrains_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Mille_supergrains_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_TheJanki_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_TheJanki_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://thejanki.com/");
		logger.info("URL is open");
		logger.info("Thejanki does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://thejanki.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in The janki after Kwikpass login passed.");
			logger.info("Verify_TheJanki_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in the janki after Kwikpass login failed.");
			logger.info("Verify_TheJanki_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_TheJanki_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_TheJanki_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Indiehaat_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Indiehaat_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://indiehaat.com/");
		logger.info("URL is open");
		logger.info("Indiehaat does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://indiehaat.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Indiehaat after Kwikpass login passed.");
			logger.info("Verify_Indiehaat_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Indiehaat after Kwikpass login failed.");
			logger.info("Verify_Indiehaat_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Indiehaat_Shopify_login_and_session_creation_after_Kwikpass_login failed");
	...
	@Test
	public void Verify_NumberFC_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_NumberFC_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://numberfc.com/");
		logger.info("URL is open");
		logger.info("NumberFC does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://numberfc.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in NUmberFC after Kwikpass login passed.");
			logger.info("Verify_NumberFC_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in NumberFC after Kwikpass login failed.");
			logger.info("Verify_NumberFC_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_NumberFC_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_NumberFC_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Zingavita_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Zingavita_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://www.zingavita.com/");
		logger.info("URL is open");
		logger.info("Zingavita does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://www.zingavita.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Zingavita after Kwikpass login passed.");
			logger.info("Verify_Zingavita_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Zingavita after Kwikpass login failed.");
			logger.info("Verify_Zingavita_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Zingavita_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Zingavita_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Aachho_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Aachho_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://www.aachho.com/");
		logger.info("URL is open");
		logger.info("Aachho does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(8);
		driver.switchTo().defaultContent();
		WebElement popup = driver.findElement(By.xpath(Aachho_popup));
		WebDriverWait popup_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		popup_wait.until(ExpectedConditions.elementToBeClickable(popup));
		if (popup.isDisplayed()) {
			popup.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://www.aachho.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Aachho after Kwikpass login passed.");
			logger.info("Verify_Aachho_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Aachho after Kwikpass login failed.");
			logger.info("Verify_Aachho_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Aachho_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Aachho_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Beco_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Beco_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://www.letsbeco.com/");
		logger.info("URL is open");
		logger.info("Beco does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://www.letsbeco.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Beco after Kwikpass login passed.");
			logger.info("Verify_Beco_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Beco after Kwikpass login failed.");
			logger.info("Verify_Beco_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Beco_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Beco_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_ASquad_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_ASquad_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://www.a-squad.in/");
		logger.info("URL is open");
		logger.info("Asquad does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://www.a-squad.in/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Asquad after Kwikpass login passed.");
			logger.info("Verify_ASquad_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Asquad after Kwikpass login failed.");
			logger.info("Verify_ASquad_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_ASquad_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_ASquad_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_WTF_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_WTF_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://wtflex.in/");
		logger.info("URL is open");
		logger.info("WTF does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://wtflex.in/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in WTF after Kwikpass login passed.");
			logger.info("Verify_WTF_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in WTF after Kwikpass login failed.");
			logger.info("Verify_WTF_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_WTF_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_WTF_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_MyFrido_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_MyFrido_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://myfrido.com/");
		logger.info("URL is open");
		logger.info("MyFrido does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://myfrido.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in MyFrido after Kwikpass login passed.");
			logger.info("Verify_MyFrido_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in MyFrido after Kwikpass login failed.");
			logger.info("Verify_MyFrido_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_MyFrido_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_MyFrido_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Unniyarcha_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Unniyarcha_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://unniyarcha.com/");
		logger.info("URL is open");
		logger.info("Unniyarcha does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://unniyarcha.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in Unniyarcha after Kwikpass login passed.");
			logger.info("Verify_Unniyarcha_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Unniyarcha after Kwikpass login failed.");
			logger.info("Verify_Unniyarcha_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Unniyarcha_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Unniyarcha_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
	
	@Test
	public void Verify_Extrokids_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Extrokids_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://extrokids.com/");
		logger.info("URL is open");
		logger.info("Extrokids does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(8);
		driver.switchTo().defaultContent();
		WebElement kp_afterlogin_btn = driver.findElement(By.xpath(Extrokids_myacc_btn));
		WebDriverWait kp_afterlogin_btn_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_afterlogin_btn_wait.until(ExpectedConditions.elementToBeClickable(kp_afterlogin_btn));
		kp_afterlogin_btn.click();
		logger.info("Clicked Myaccount btn");
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://extrokids.com/account";
		if (curl.equals(vurl)) {			
			logger.info("Shopify login and session created in Extrokids after Kwikpass login .");
			logger.info("Verify_Extrokids_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Extrokids after Kwikpass login .");
			logger.info("Verify_Extrokids_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Extrokids_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Extrokids_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	...
	@Test
	public void Verify_TheBearHouse_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_TheBearHouse_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://thebearhouse.com/");
		logger.info("URL is open");
		logger.info("TheBearHouse does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://thebearhouse.com/account";
		if (curl.equals(vurl)) {			
			logger.info("Shopify login and session created in TheBearHouse after Kwikpass login .");
			logger.info("Verify_TheBearHouse_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in TheBearHouse after Kwikpass login .");
			logger.info("Verify_TheBearHouse_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_TheBearHouse_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_TheBearHouse_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}

	}
	
	@Test
	public void Verify_Fabcurate_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		logger.info("Verify_Fabcurate_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://fabcurate.com/");
		logger.info("URL is open");
		logger.info("Fabcurate does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://fabcurate.com/account";
		if (curl.equals(vurl)) {			
			logger.info("Shopify login and session created in Fabcurate after Kwikpass login .");
			logger.info("Verify_Fabcurate_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in Fabcurate after Kwikpass login .");
			logger.info("Verify_Fabcurate_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_Fabcurate_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_Fabcurate_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}

	}
	
	@Test
	public void Verify_BlissClub_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException {
		logger.info("Verify_BlissClub_Shopify_login_and_session_creation_after_Kwikpass_login Test case is running.....");
		driver.get("https://blissclub.com/");
		logger.info("URL is open");
		logger.info("BlissClub does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		...
		sleep(10);
		String curl = driver.getCurrentUrl();
		String vurl = "https://blissclub.com/account";
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Shopify login and session created in BlissClub after Kwikpass login passed.");
			logger.info("Verify_BlissClub_Shopify_login_and_session_creation_after_Kwikpass_login Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Shopify login and session not created in BlissClub after Kwikpass login failed.");
			logger.info("Verify_BlissClub_Shopify_login_and_session_creation_after_Kwikpass_login Test Case failed!");
			captureScreen(driver, "Verify_BlissClub_Shopify_login_and_session_creation_after_Kwikpass_login failed");
			Assert.fail("Verify_BlissClub_Shopify_login_and_session_creation_after_Kwikpass_login failed");
		}
	}
