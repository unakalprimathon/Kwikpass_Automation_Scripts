...
public class TC_Luxaderme_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Luxaderme_KwikPass_login_icon_Visibilty() throws IOException, InterruptedException {
		logger.info("Verify_Luxaderme_KwikPass_login_icon_Visibilty Test case is running.....");
		driver.get("https://luxaderme.in/");
		...
		if (kp_login_btn.isDisplayed()) {
			...
			logger.info("Verify_Luxaderme_KwikPass_login_icon_Visibilty Test case Failed !");
			captureScreen(driver, "Verify_Luxaderme_KwikPass_login_icon_Visibilty failed");
			Assert.fail("Verify_Luxaderme_KwikPass_login_icon_Visibilty failed");
		}
	}
	

	@Test
	public void Verify_Luxaderme_Kwikpass_login_using_OTP_Via_SMS() throws IOException, InterruptedException {
		logger.info("Verify_Luxaderme_Kwikpass_login_using_OTP_Via_SMS Test case is running.....");
		driver.get("https://luxaderme.in/");
		logger.info("URL is open");
		logger.info("Luxaderme does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			logger.info("Verify_Luxaderme_Kwikpass_login_using_OTP_Via_SMS Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_Luxaderme_Kwikpass_login_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_Luxaderme_Kwikpass_login_using_OTP_Via_SMS failed !");
			Assert.fail("Verify_Luxaderme_Kwikpass_login_using_OTP_Via_SMS failed");
		}
	}
	...
	@Test
	public void Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen() throws IOException, InterruptedException {
		logger.info("Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen Test case is running.....");
		driver.get("https://luxaderme.in/");
		logger.info("URL is open");
		logger.info("Luxaderme does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			sleep(3);
			driver.navigate().to("https://luxaderme.in/collections/our-bestsellers/products/luxaderme-detox-bio-cellulose-sheet-mask");
			logger.info("Navigated to PDP page");
			WebElement addtobag = driver.findElement(By.xpath(luxaderme_addtobag));
			WebDriverWait addtobag_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			addtobag_wait.until(ExpectedConditions.elementToBeClickable(addtobag));
			addtobag.click();
			logger.info("Clicked Buy now button");
			sleep(5);
			WebElement ordernow = driver.findElement(By.xpath(luxaderme_checkout));
			...
			if (X.equals(x1)) {
				...
				sleep(2);
				logger.info("Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen Test case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Gokwik login fail");
				logger.info("Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen Test case failed!");
				captureScreen(driver, "FVerify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen failed");
				Assert.fail("Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen Test Cases failed!");
			captureScreen(driver, "Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen failed !");
			Assert.fail("Verify_Luxaderme_Kwikpass_login_Done_Gokwik_login_should_happen failed");
		}
	}
	
	@Test
	public void Verify_Luxaderme_KwikPass_Login_modal_Verfication_at_accountpage()throws IOException, InterruptedException {
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			logger.info("Verify_Luxaderme_KwikPass_Login_modal_Verfication_at_accountpage Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Luxaderme_KwikPass_Login_modal_Verfication_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Luxaderme_KwikPass_Login_modal_Verfication_at_accountpage failed");
			Assert.fail("Verify_Luxaderme_KwikPass_Login_modal_Verfication_at_accountpage failed");
		}
	}

	@Test
	public void Verify_Luxaderme_KwikPass_Login_at_accountpage() throws IOException, InterruptedException {
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_Luxaderme_KwikPass_Login_at_accountpage Test Cases passed!");
				logger.info("Test Cases Completed !");
			} else {
				logger.info("Verify_Luxaderme_KwikPass_Login_at_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Luxaderme_KwikPass_Login_at_accountpage failed");
				Assert.fail("Verify_Luxaderme_KwikPass_Login_at_accountpage failed");
			}
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Luxaderme_KwikPass_Login_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Luxaderme_KwikPass_Login_at_accountpage failed");
			Assert.fail("Verify_Luxaderme_KwikPass_Login_at_accountpage failed");
		}
	}
	...
	@Test
	public void Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage()throws IOException, InterruptedException {
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			if (curl.equals(vurl)) {
				driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
				logger.info("Login Successful !");
				logger.info("Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_Luxaderme_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
