...
public class TC_Saadaa_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Saadaa_KwikPass_AP_modal_Verfication() throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_KwikPass_AP_modal_Verfication Test Case is running.....");
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			logger.info("Verify_Saadaa_KwikPass_AP_modal_Verfication Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_modal_Verfication Test Cases failed!");
			captureScreen(driver, "Verify_Saadaa_KwikPass_AP_modal_Verfication failed");
			Assert.fail("Verify_Saadaa_KwikPass_AP_modal_Verfication failed");
		}
	}

	@Test
	public void Verify_Saadaa_KwikPass_AP_Visiblity_At_Collection_page() throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_Collection_page Test case is running.....");
		driver.get("https://saadaa.in/");
		logger.info("URL is open");
		logger.info("Saadaa has Kwikpass Auto Load Popup");
		driver.navigate().to("https://saadaa.in/collections/short-kurtas");
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			logger.info("The Kwikpass Login modal has OTP via SMS and WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_Collection_page Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_Collection_page Test Cases failed!");
			captureScreen(driver, "Verify_Saadaa_KwikPass_AP_Visiblity_At_Collection_page failed");
			Assert.fail("Verify_Saadaa_KwikPass_AP_Visiblity_At_Collection_page failed");
		}
	}

	@Test
	public void Verify_Saadaa_KwikPass_AP_Visiblity_At_Home_page() throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_Home_page Test Case is running.....");
		driver.get("https://saadaa.in/");
		logger.info("URL is open");
		logger.info("Saadaa has Kwikpass AP");
		sleep(13);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			logger.info("The Kwikpass Login modal has OTP via SMS and WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_Home_page Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_Home_page Test Cases failed!");
			captureScreen(driver, "Verify_Saadaa_KwikPass_AP_Visiblity_At_Home_page failed");
			Assert.fail("Verify_Saadaa_KwikPass_AP_Visiblity_At_Home_page failed");
		}
	}

	@Test
	public void Verify_Saadaa_KwikPass_AP_Visiblity_At_PDP_page() throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_PDP_page Test case is running.....");
		driver.get("https://saadaa.in/");
		logger.info("URL is open");
		logger.info("Saadaa has Kwikpass Auto Load Popup");
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			logger.info("The Kwikpass Login modal has OTP via SMS and WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_PDP_page Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Saadaa_KwikPass_AP_Visiblity_At_PDP_page Test Cases failed!");
			captureScreen(driver, "Verify_Saadaa_KwikPass_AP_Visiblity_At_PDP_page failed");
			Assert.fail("Verify_Saadaa_KwikPass_AP_Visiblity_At_PDP_page failed");
		}
	}

	@Test
	public void Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen()throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test Case is running.....");
		driver.get("https://saadaa.in/");
		logger.info("URL is open");
		logger.info("Saadaa has Kwikpass AP");
		LoginPage lp = new LoginPage(driver);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (x.equals(x11)) {
				...
				if (X.equals(x1)) {
					...
					logger.info("Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test case passed!");
					logger.info("Test Case Completed !");
				} else {
					logger.info("Gokwik login fail");
					logger.info("Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test case failed!");
					captureScreen(driver,"Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed");
					Assert.fail("Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed");
				}
			} else {
				logger.info("Login Unsuccessful !");
				logger.info("Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test Cases failed!");
				captureScreen(driver, "Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed !");
				Assert.fail("Verify_Saadaa_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed");
			}
	...
	@Test
	public void Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS() throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS Test Case is running.....");
		driver.get("https://saadaa.in/");
		logger.info("URL is open");
		logger.info("Saadaa has Kwikpass AP");
		LoginPage lp = new LoginPage(driver);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (x.equals(x11)) {
				logger.info("Login Successful !");
				logger.info("Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Login Unsuccessful !");
				logger.info("Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS Test Cases failed!");
				captureScreen(driver, "Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS login failed !");
				Assert.fail("Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS failed");
			}
		} else {
			logger.info("The Kwikpass AP modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS failed");
			Assert.fail("Verify_Saadaa_Kwikpass_login_from_AP_using_OTP_Via_SMS failed");
		}
	}
	...
	@Test
	public void Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP()throws IOException, InterruptedException {
		logger.info("Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP Test Case is running.....");
		driver.get("https://saadaa.in/");
		logger.info("URL is open");
		logger.info("Saadaa has Kwikpass AP");
		LoginPage lp = new LoginPage(driver);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (x.equals(x11)) {
				...
				if (curl.equals(vurl)) {
					...
					logger.info("Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP Test Case passed!");
					logger.info("Test Case Completed !");
				} else {
					logger.info("Shopify login and session not created in Urban Jungle after Kwikpass login .");
					logger.info("Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP Test Case failed!");
					captureScreen(driver,"Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP failed");
					Assert.fail("Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP failed");
				}
			} else {
				logger.info("Login Unsuccessful !");
				logger.info("Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP Test Cases failed!");
				captureScreen(driver,"Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP failed !");
				Assert.fail("Verify_Saadaa_Shopify_login_and_session_creation_after_Kwikpass_login_from_AP failed");
			}
		} else {
