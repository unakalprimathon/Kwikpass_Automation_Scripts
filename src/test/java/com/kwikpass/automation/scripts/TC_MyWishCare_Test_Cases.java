...
public class TC_MyWishCare_Test_Cases extends BaseClass implements Locator{
	...
	public void Verify_MyWishCare_Kwikpass_login_using_OTP_Via_SMS() throws IOException, InterruptedException {
		...
		WebElement closepopup = driver.findElement(By.xpath(MyWishCare_closepopup));
	...
	public void Verify_MyWishCare_Shopify_login_and_session_creation_after_Kwikpass_login() throws IOException{
		...
		if (curl.equals(vurl)) {
			sleep(5);
			WebElement closepopup1 = driver.findElement(By.xpath(MyWishCare_closepopup));
			WebDriverWait closepopup1_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			closepopup1_wait.until(ExpectedConditions.elementToBeClickable(closepopup1));
			closepopup1.click();
			logger.info("closed popup");
			sleep(2);
