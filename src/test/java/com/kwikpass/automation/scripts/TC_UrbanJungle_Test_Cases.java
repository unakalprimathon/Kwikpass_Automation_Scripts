...
public class TC_UrbanJungle_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen() throws IOException, InterruptedException {
		logger.info("Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test Case is running.....");
		driver.get("https://urbanjungle.shop/");
		logger.info("URL is open");
		logger.info("Urban Jungle has Kwikpass AP");
		sleep(13);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (logoutbtnPresent && orderhistorybtnPresent) {
				...
				sleep(3);
				driver.navigate().to("https://urbanjungle.shop/products/the-carry-on");
				logger.info("Navigated to PDP page");
				WebElement addtocart = driver.findElement(By.xpath(urbanjungle_addtocart));
				...
				sleep(2);
				WebElement proceedtocheckout = driver.findElement(By.className(urbanjungle_proceedtocheckout));
				...
				if (X.equals(x1)) {
					...
					logger.info("Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test case failed!");
					captureScreen(driver, "Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed");
					Assert.fail("Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed");
				}
			} else {
				logger.info("Login Unsuccessful !");
				logger.info("Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen Test Cases failed!");
				captureScreen(driver, "Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed !");
				Assert.fail("Verify_UrbanJungle_Kwikpass_login_from_AP_Done_Gokwik_login_should_happen failed");
			}
	...
	@Test
	public void Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen() throws IOException, InterruptedException {
		logger.info("Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen Test case is running.....");
		driver.get("https://urbanjungle.shop/");
		logger.info("URL is open");
		logger.info("Urban Jungle has Kwikpass AP");
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			if (X.equals(x1)) {
				...
				logger.info("Gokwik login fail");
				logger.info("Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen Test case failed!");
				captureScreen(driver, "Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen failed");
				Assert.fail("Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen Test Cases failed!");
			captureScreen(driver, "Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen failed !");
			Assert.fail(" Verify_UrbanJungle_Kwikpass_login_from_Login_Modal_Done_Gokwik_login_should_happen failed");
		}
