...
public class TC_Dennis_Lingo_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Dennis_Lingo_KwikPass_login_icon_Visibilty() throws IOException, InterruptedException {
		logger.info("Verify_Dennis_Lingo_KwikPass_login_icon_Visibilty Test case is running.....");
		driver.get("https://www.dennislingo.com/");
		...
		if (s.isDisplayed()) {
			...
			logger.info("Verify_Dennis_Lingo_KwikPass_login_icon_Visibilty Test case Failed !");
			captureScreen(driver, "Verify_Dennis_Lingo_KwikPass_login_icon_Visibilty failed");
			Assert.fail("Verify_Dennis_Lingo_KwikPass_login_icon_Visibilty failed");
		}
	}
	

	@Test
	public void Verify_Dennis_Lingo_Kwikpass_login_using_OTP_Via_SMS() throws IOException, InterruptedException {
		logger.info("Verify_Dennis_Lingo_Kwikpass_login_using_OTP_Via_SMS Test case is running.....");
		driver.get("https://www.dennislingo.com/");
		logger.info("URL is open");
		logger.info("Dennis_Lingo does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			logger.info("Verify_Dennis_Lingo_Kwikpass_login_using_OTP_Via_SMS Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_Dennis_Lingo_Kwikpass_login_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_Dennis_Lingo_Kwikpass_login_using_OTP_Via_SMS failed !");
			Assert.fail("Verify_Dennis_Lingo_Kwikpass_login_using_OTP_Via_SMS failed");
		}
	}
	...
	@Test
	public void Verify_Dennis_Lingo_KwikPass_Login_modal_Verfication_at_accountpage()throws IOException, InterruptedException {
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			logger.info("Verify_Dennis_Lingo_KwikPass_Login_modal_Verfication_at_accountpage Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Dennis_Lingo_KwikPass_Login_modal_Verfication_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Dennis_Lingo_KwikPass_Login_modal_Verfication_at_accountpage failed");
			Assert.fail("Verify_Dennis_Lingo_KwikPass_Login_modal_Verfication_at_accountpage failed");
		}
	}

	@Test
	public void Verify_Dennis_Lingo_KwikPass_Login_at_accountpage() throws IOException, InterruptedException {
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_Dennis_Lingo_KwikPass_Login_at_accountpage Test Cases passed!");
				logger.info("Test Cases Completed !");
			} else {
				logger.info("Verify_Dennis_Lingo_KwikPass_Login_at_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Dennis_Lingo_KwikPass_Login_at_accountpage failed");
				Assert.fail("Verify_Dennis_Lingo_KwikPass_Login_at_accountpage failed");
			}
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Dennis_Lingo_KwikPass_Login_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Dennis_Lingo_KwikPass_Login_at_accountpage failed");
			Assert.fail("Verify_Dennis_Lingo_KwikPass_Login_at_accountpage failed");
		}
	}
	...
	@Test
	public void Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage()throws IOException, InterruptedException {
		...
		boolean orderhistorybtnPresent = !driver.findElements(orderhistorybtn).isEmpty();
		if (logoutbtnPresent && orderhistorybtnPresent) {
			driver.navigate().to("https://www.dennislingo.com/account");
			sleep(10);
			String curl = driver.getCurrentUrl();
			String vurl = "https://www.dennislingo.com/account";
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_Dennis_Lingo_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
