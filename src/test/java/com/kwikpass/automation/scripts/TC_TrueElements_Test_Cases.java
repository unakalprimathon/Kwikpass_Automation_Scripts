...
//	@Test
//	public void Verify_TrueElements_Kwikpass_login_using_OTP_Via_SMS_from_Rewards() throws IOException, InterruptedException {
//		logger.info("Verify_TrueElements_Kwikpass_login_using_OTP_Via_SMS_from_Rewards Test case is running.....");
//		driver.get("https://true-elements.com/");
//		logger.info("URL is open");
//		logger.info("TrueElements does not have Kwikpass AP");
//		LoginPage lp = new LoginPage(driver);
//		sleep(5);
//		WebElement rewards_btn = driver.findElement(By.id("bluepine-lite-launcher-frame"));
...
//		sleep(5);
//		lp.switchToIframe("bluepine-lite-launcher-frame");
...
//			logger.info("Kwikpass Login Successful !");
//			logger.info("Verify_TrueElements_Kwikpass_login_using_OTP_Via_SMS_from_Rewards Test Case passed!");
//			logger.info("Test Case Completed !");
//		} else {
//			logger.info("Kwikpass Login Unsuccessful !");
//			logger.info("Verify_TrueElements_Kwikpass_login_using_OTP_Via_SMS_from_Rewards Test Cases failed!");
//			captureScreen(driver, "Verify_TrueElements_Kwikpass_login_using_OTP_Via_SMS_from_Rewards failed !");
//			Assert.fail("Verify_TrueElements_Kwikpass_login_using_OTP_Via_SMS_from_Rewards failed");
//		}
//
//	}
}
