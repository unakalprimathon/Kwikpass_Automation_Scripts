...
public class TC_GBT_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_GBT_KwikPass_login_icon_Visibilty() throws IOException, InterruptedException {
		logger.info("Verify_GBT_KwikPass_login_icon_Visibilty Test case is running.....");
		driver.get("https://growbilliontrees.com/");
		...
		if (kp_login_btn.isDisplayed()) {
			...
			logger.info("Verify_GBT_KwikPass_login_icon_Visibilty Test case Passed !");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass icon not-visible");
			logger.info("Verify_GBT_KwikPass_login_icon_Visibilty Test case Failed !");
			captureScreen(driver, "Verify_GBT_KwikPass_login_icon_Visibilty failed");
			Assert.fail("Verify_GBT_KwikPass_login_icon_Visibilty failed");
		}
	}
	

	@Test
	public void Verify_GBT_Kwikpass_login_using_OTP_Via_SMS() throws IOException, InterruptedException {
		logger.info("Verify_GBT_Kwikpass_login_using_OTP_Via_SMS Test case is running.....");
		driver.get("https://growbilliontrees.com/");
		logger.info("URL is open");
		logger.info("GBT does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			logger.info("Verify_GBT_Kwikpass_login_using_OTP_Via_SMS Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_GBT_Kwikpass_login_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_GBT_Kwikpass_login_using_OTP_Via_SMS failed !");
			Assert.fail("Verify_GBT_Kwikpass_login_using_OTP_Via_SMS failed");
		}
	}
	...
	@Test
	public void Verify_GBT_Kwikpass_login_from_cart() throws IOException, InterruptedException {
		logger.info("Verify_GBT_Kwikpass_login_from_cart Test case is running.....");
		driver.get("https://growbilliontrees.com/");
		logger.info("URL is open");
		logger.info("GBT does not have Kwikpass AP");
		WebElement cart_btn = driver.findElement(By.id(GBT_cart_btn));
		...
		sleep(3);
		WebElement kp_login_btn = driver.findElement(By.xpath(GBT_login_btn));
		WebDriverWait kp_wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		kp_wait.until(ExpectedConditions.elementToBeClickable(kp_login_btn));
		kp_login_btn.click();
		logger.info("Clicked cart Icon");
		...
		if (curl.equals(vurl)) {
			driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
			logger.info("Kwikpass Login Successful !");
			logger.info("Verify_GBT_Kwikpass_login_from_cart Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_GBT_Kwikpass_login_from_cart Test Cases failed!");
			captureScreen(driver, "Verify_GBT_Kwikpass_login_from_cart failed !");
			Assert.fail("Verify_GBT_Kwikpass_login_from_cart failed");
		}
	}
	
	@Test
	public void Verify_GBT_KwikPass_Login_modal_Verfication_at_accountpage()throws IOException, InterruptedException {
		logger.info("Verify_GBT_KwikPass_Login_modal_Verfication_at_accountpage Test case is running.....");
		driver.get("https://growbilliontrees.com/account");
		logger.info("URL is open");
		logger.info("GBT has Kwikpass AP");
		logger.info("Clicked Kwikpass Icon");
		LoginPage lp = new LoginPage(driver);
		sleep(3);
		lp.switchToIframe(kwikpass_iframe);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			logger.info("Verify_GBT_KwikPass_Login_modal_Verfication_at_accountpage Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_GBT_KwikPass_Login_modal_Verfication_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_GBT_KwikPass_Login_modal_Verfication_at_accountpage failed");
			Assert.fail("Verify_GBT_KwikPass_Login_modal_Verfication_at_accountpage failed");
		}
	}

	@Test
	public void Verify_GBT_KwikPass_Login_at_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_GBT_KwikPass_Login_at_accountpage Test case is running.....");
		driver.get("https://growbilliontrees.com/account");
		logger.info("URL is open");
		logger.info("GBT has Kwikpass AP");
		logger.info("Clicked Kwikpass Icon");
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_GBT_KwikPass_Login_at_accountpage Test Cases passed!");
				logger.info("Test Cases Completed !");
			} else {
				logger.info("Verify_GBT_KwikPass_Login_at_accountpage Test Case failed!");
				captureScreen(driver,"Verify_GBT_KwikPass_Login_at_accountpage failed");
				Assert.fail("Verify_GBT_KwikPass_Login_at_accountpage failed");
			}
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_GBT_KwikPass_Login_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_GBT_KwikPass_Login_at_accountpage failed");
			Assert.fail("Verify_GBT_KwikPass_Login_at_accountpage failed");
		}
	}
	...
	@Test
	public void Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage()throws IOException, InterruptedException {
		logger.info("Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage Test case is running.....");
		driver.get("https://growbilliontrees.com/");
		logger.info("URL is open");
		logger.info("GBT has Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		boolean orderhistorybtnPresent = !driver.findElements(orderhistorybtn).isEmpty();
		if (logoutbtnPresent && orderhistorybtnPresent) {
			driver.navigate().to("https://growbilliontrees.com/account");
			sleep(10);
			String curl = driver.getCurrentUrl();
			String vurl = "https://growbilliontrees.com/account";
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver,"Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_GBT_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
