...
public class TC_Nurserylive_Pune_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS() throws IOException, InterruptedException {
		logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS Test case is running.....");
		driver.get("https://pune.nurserylive.com/");
		logger.info("URL is open");
		logger.info("Nurserylive_Pune does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.className(Nurserylive_Pune_kp_icon));
		...
		if (logoutbtnPresent && myaccountbtnPresent) {
			...
			logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS failed !");
			Assert.fail("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS failed");
		}

	}
	
	@Test
	public void Verify_Nurserylive_Pune_KwikPass_login_icon_Visibilty() throws IOException, InterruptedException {
		logger.info("Verify_Nurserylive_Pune_KwikPass_login_icon_Visibilty Test case is running.....");
		driver.get("https://pune.nurserylive.com/");
		...
		if (s.isDisplayed()) {
			...
			logger.info("Verify_Nurserylive_Pune_KwikPass_login_icon_Visibilty Test case Passed !");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass icon not-visible");
			logger.info("Verify_Nurserylive_Pune_KwikPass_login_icon_Visibilty Test case Failed !");
			captureScreen(driver, "Verify_Nurserylive_Pune_KwikPass_login_icon_Visibilty failed");
			Assert.fail("Verify_Nurserylive_Pune_KwikPass_login_icon_Visibilty failed");
		}
	}
	...
	@Test
	public void Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage Test case is running.....");
		driver.get("https://pune.nurserylive.com/account");
		logger.info("URL is open");
		logger.info("Nurserylive_Pune does not have Kwikpass AP");
		LoginPage lp = new LoginPage(driver);
		sleep(3);
		...
		if (optidpresent && whatsappidpresent) {
			logger.info("The Kwikpass Login modal has OTP via SMS and WhatsApp login options.");
			logger.info("Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage Test Cases passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn'tt has OTP via SMS and WhatsApp login.");
			logger.info("Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage failed");
			Assert.fail("Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage failed");
		}
	}
	
	@Test
	public void Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test case is running.....");
		logger.info("Verify_Nurserylive_Pune_KwikPass_login_modal_verification_from_accountpage Test case is running.....");
		driver.get("https://pune.nurserylive.com/account");
		logger.info("URL is open");
		logger.info("Nurserylive_Pune does not have Kwikpass AP");
		...
		if (optidpresent && whatsappidpresent) {
			...
			if (curl.equals(vurl)) {				
				...
				logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Kwikpass login unsuccessful.");
				logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test Case failed!");
				captureScreen(driver, "Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage failed");
				Assert.fail("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Failed");
			}
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage failed !");
			Assert.fail("Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_accountpage failed");
		}
	...
	@Test
	public void Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage Test case is running.....");
		driver.get("https://pune.nurserylive.com/");
		logger.info("URL is open");
		logger.info("Nurserylive_Pune does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.className(Nurserylive_Pune_kp_icon));
		...
		boolean myaccountbtnPresent = !driver.findElements(myaccountbtn).isEmpty();
		if (logoutbtnPresent && myaccountbtnPresent) {
			driver.navigate().to("https://pune.nurserylive.com/account");
			...
			if (curl.equals(vurl)) {
				logger.info("Kwikpass Login Successful !");
				logger.info("Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver, "Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage Failed");
			}
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_Nurserylive_Pune_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
	}
	...
	public void Verify_Nurserylive_Pune_Kwikpass_login_using_OTP_Via_SMS_from_Rewards() throws IOException, InterruptedException {
		...
		LoginPage lp = new LoginPage(driver);
		sleep(5);
		WebElement rewards_btn = driver.findElement(By.id(Nurserylive_Punereward_btn));
		...
		sleep(5);
		WebElement rewards_join_now_btn = driver.findElement(By.xpath(Nurserylive_Pune_join_nowin_btn));
		...
		logger.info("Clicked rewards_join_now_btn ");
		sleep(5);
		lp.switchToIframe(kwikpass_iframe);
		logger.info("switched to Kwikpass login modal iframe");
		driver.findElement(By.id(mobile_input)).sendKeys(mobile_number);
