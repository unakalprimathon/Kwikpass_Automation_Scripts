...
public class TC_Dot_And_key_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Dot_And_Key_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS() throws IOException, InterruptedException {
		logger.info("Verify_Dot_And_Key_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS Test case is running.....");
		driver.get("https://www.dotandkey.com/");
		logger.info("URL is open");
		logger.info("Dot_And_Key has Kwikpass AP");
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			logger.info("Kwikpass Login Successful !");
			sleep(3);
			logger.info("Verify_Dot_And_Key_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_Dot_And_Key_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_Dot_And_Key_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS failed !");
			Assert.fail("Verify_Dot_And_Key_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS failed");
		}

	}

	@Test
	public void Verify_Dot_And_Key_KwikPass_icon_visibility() throws IOException, InterruptedException {
		logger.info("Verify_Dot_And_Key_KwikPass_icon_visibility Test case is running.....");
		driver.get("https://www.dotandkey.com/");
		logger.info("URL is open");
		logger.info("Dot_And_Key has Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		if (kp_login_btn.isDisplayed()) {
			...
			logger.info("Verify_Dot_And_Key_KwikPass_login_icon_Visibilty test case failed!");
			captureScreen(driver, "Verify_Dot_And_Key_KwikPass_icon_visibility failed");
			Assert.fail("Verify_Dot_And_Key_KwikPass_icon_visibility failed");
		}
	...
	@Test
	public void Verify_Dot_And_Key_KwikPass_Login_modal_Verfication_at_accountpage()throws IOException, InterruptedException {
		logger.info("Verify_Dot_And_Key_KwikPass_Login_modal_Verfication_at_accountpage Test case is running.....");
		driver.get("https://www.dotandkey.com/account");
		logger.info("URL is open");
		logger.info("Dot_And_Key has Kwikpass AP");
		logger.info("Clicked Kwikpass Icon");
		LoginPage lp = new LoginPage(driver);
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			logger.info("The Kwikpass Login modal has OTP via SMS and WhatsApp login options.");
			logger.info("Verify_Dot_And_Key_KwikPass_Login_modal_Verfication_at_accountpage Test Cases passed!");
			logger.info("Test Cases Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Dot_And_Key_KwikPass_Login_modal_Verfication_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Dot_And_Key_KwikPass_Login_modal_Verfication_at_accountpage failed");
			Assert.fail("Verify_Dot_And_Key_KwikPass_Login_modal_Verfication_at_accountpage failed");
		}
	}

	@Test
	public void Verify_Dot_And_Key_KwikPass_Login_at_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_Dot_And_Key_KwikPass_Login_at_accountpage Test case is running.....");
		driver.get("https://www.dotandkey.com/account");
		logger.info("URL is open");
		logger.info("Dot_And_Key has Kwikpass AP");
		logger.info("Clicked Kwikpass Icon");
		...
		if (mobile_input_fieldpresent && whatsapp_btnpresent) {
			...
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_Dot_And_Key_KwikPass_Login_at_accountpage Test Cases passed!");
				logger.info("Test Cases Completed !");
			} else {
				logger.info("Verify_Dot_And_Key_KwikPass_Login_at_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Dot_And_Key_KwikPass_Login_at_accountpage failed");
				Assert.fail("Verify_Dot_And_Key_KwikPass_Login_at_accountpage failed");
			}
		} else {
			logger.info("The Kwikpass Login modal doesn't has OTP via SMS or WhatsApp login options.");
			logger.info("Verify_Dot_And_Key_KwikPass_Login_at_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Dot_And_Key_KwikPass_Login_at_accountpage failed");
			Assert.fail("Verify_Dot_And_Key_KwikPass_Login_at_accountpage failed");
		}
	}
	...
	@Test
	public void Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage()throws IOException, InterruptedException {
		logger.info("Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage Test case is running.....");
		driver.get("https://www.dotandkey.com/");
		logger.info("URL is open");
		logger.info("Dot_And_Key has Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		boolean orderhistorybtnPresent = !driver.findElements(orderhistorybtn).isEmpty();
		if (logoutbtnPresent && orderhistorybtnPresent) {
			driver.navigate().to("https://www.dotandkey.com/account");
			sleep(10);
			String curl = driver.getCurrentUrl();
			String vurl = "https://www.dotandkey.com/account";
			if (curl.equals(vurl)) {
				driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
				logger.info("Login Successful !");
				logger.info("Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_Dot_And_Key_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
