...
public class TC_Soul_Flower_Test_Cases extends BaseClass implements Locator{
	...
	@Test
	public void Verify_Soul_Flower_KwikPass_login_modal_verification() throws IOException, InterruptedException {
		logger.info("Verify_Soul_Flower_KwikPass_login_modal_verification Test case is running.....");
		...
		if (mobileinputfieldpresent && whatsappidpresent) {
			...
			logger.info("Verify_Soul_Flower_KwikPass_login_modal_verification Test Cases passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("The Kwikpass Login modal verification failed.");
			logger.info("Verify_Soul_Flower_KwikPass_login_modal_verification Test Cases failed!");
			captureScreen(driver, "Verify_Soul_Flower_KwikPass_login_modal_verification failed");
			Assert.fail("Verify_Soul_Flower_KwikPass_login_modal_verification failed");
		}
	}
	...
	@Test
	public void Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage()throws IOException, InterruptedException {
		logger.info("Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage Test case is running.....");
		driver.get("https://www.soulflower.in/");
		logger.info("URL is open");
		logger.info("Soul_Flower has Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.id(kwikpass_icon_bl));
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			driver.navigate().to("https://www.soulflower.in/account");
			sleep(10);
			String curl = driver.getCurrentUrl();
			String vurl = "https://www.soulflower.in/account";
			if (curl.equals(vurl)) {
				...
				logger.info("Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver,"Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage failed");
			}
		} else {
			logger.info("Login Unsuccessful !");
			logger.info("Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_Soul_Flower_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
