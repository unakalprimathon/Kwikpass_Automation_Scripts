...
public class TC_TheHatke_Test_Cases extends BaseClass implements Locator{
	...
	public void Verify_TheHatke_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS() throws IOException, InterruptedException {
		...
		if (logoutbtnPresent || orderhistorybtnPresent) {
			logger.info("Kwikpass Login Successful !");
			logger.info("Verify_TheHatke_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS Test Case passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_TheHatke_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS Test Cases failed!");
			captureScreen(driver, "Verify_TheHatke_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS failed !");
			Assert.fail("Verify_TheHatke_Kwikpass_login_from_Login_Modal_using_OTP_Via_SMS failed");
		}
	...
	@Test
	public void Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage Test case is running.....");
		driver.get("https://thehatke.com/account");
		logger.info("URL is open");
		...
		if (optidpresent && whatsappidpresent) {
			logger.info("The Kwikpass Login modal has OTP via SMS and WhatsApp login options.");
			logger.info("Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage Test Cases passed!");
			logger.info("Test Case Completed !");
		} else {
			logger.info("The Kwikpass Login modal doesn'tt has OTP via SMS and WhatsApp login.");
			logger.info("Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage failed");
			Assert.fail("Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage failed");
		}
	}
	
	@Test
	public void Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test case is running.....");
		logger.info("Verify_TheHatke_KwikPass_login_modal_verification_from_accountpage Test case is running.....");
		driver.get("https://thehatke.com/account");
		logger.info("URL is open");
		logger.info("TheHatke does not have Kwikpass AP");
		...
		if (optidpresent && whatsappidpresent) {
			...
			if (curl.equals(vurl)) {
				driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
				logger.info("Kwikpass Login Successful !");
				logger.info("Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Kwikpass login unsuccessful.");
				logger.info("Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test Case failed!");
				captureScreen(driver, "Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage failed");
				Assert.fail("Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Failed");
			}
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage failed !");
			Assert.fail("Verify_TheHatke_Kwikpass_login_using_OTP_Via_SMS_from_accountpage failed");
		}
	...
	@Test
	public void Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage() throws IOException, InterruptedException {
		logger.info("Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage Test case is running.....");
		driver.get("https://thehatke.com/");
		logger.info("URL is open");
		logger.info("TheHatke does not have Kwikpass AP");
		WebElement kp_login_btn = driver.findElement(By.xpath(hatke_login_btn));
		...
		if (logoutbtnPresent && orderhistorybtnPresent) {
			...
			if (curl.equals(vurl)) {
				driver.findElement(By.xpath(acc_logout_btn)).isDisplayed();
				logger.info("Kwikpass Login Successful !");
				logger.info("Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage Test Case passed!");
				logger.info("Test Case Completed !");
			} else {
				logger.info("Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage Test Case failed!");
				captureScreen(driver, "Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage failed");
				Assert.fail("Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage Failed");
			}
		} else {
			logger.info("Kwikpass Login Unsuccessful !");
			logger.info("Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage Test Cases failed!");
			captureScreen(driver, "Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage failed !");
			Assert.fail("Verify_TheHatke_Kwikpass_login_Done_Redirect_to_accountpage failed");
		}
	}
