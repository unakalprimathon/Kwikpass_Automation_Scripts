...
public class EmailSender_For_High_Traffic_Merchant{
    ...
    public void SendEmail() {
        ...
        try {
            ...
            message.setSubject("Automation Testing Report - On High Traffic Merchant");

            // Set the email body
            MimeBodyPart textMime = new MimeBodyPart();
            textMime.setText("Hi All,\n\n" + "Please find the attached Automation Testing Report - On High Traffic Merchant.\n"
