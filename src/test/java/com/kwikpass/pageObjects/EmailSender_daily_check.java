...
public class EmailSender_daily_check{
    ...
    public void SendEmail() {
        ...
        try {
            ...
            message.setSubject("Automation Testing Report - Quick Sanity to perform KP_login & Shopify login");

            // Set the email body
            MimeBodyPart textMime = new MimeBodyPart();
            textMime.setText("Hi All,\n\n" + "Please find the attached Automation Testing Report - Quick Sanity to perform KP_login & Shopify login on all live merchants.\n"
